...
Source0  : https://files.pythonhosted.org/packages/6e/b7/22436c0859d3c66ea03f4b8a05c259ccf1295ef9099cd43e35de50314d7c/devpi_process-1.0.2.tar.gz
...
%prep
%setup -q -n devpi_process-1.0.2
cd %{_builddir}/devpi_process-1.0.2
pushd ..
cp -a devpi_process-1.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726670974
